...
Event objects MAY be mutable should the use case call for Listeners providing
...
Listener Providers MUST treat parent types identically to the Event's own type
